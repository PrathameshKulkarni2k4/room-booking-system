...
const createBooking = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, booking, "Room booked successfully"));
});
...
const updateBookingStatus = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, booking, "Booking status has changed"));
});
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        bookedRooms,
        "Approved booked rooms fetched successfully"
      )
    );
});
...
const checkUserBookedRoom = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, { booked }, "Booking status fetched"));
});
